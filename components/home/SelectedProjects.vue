...
const floatinTextHeader: Ref<any> = ref(null)
const floatingTextDesc: Ref<any> = ref(null)
const floatingBox: Ref<any> = ref(null)
const projectBoxes: Ref<any> = ref([])

// function for displaying the floating box
function floatingBoxFadeIn(e: any, id: any) {
  ...
  >
    ...
    <div class="projects">
      <div
        ...
        @mousemove="e => {
          floatingBoxFadeIn(e, project.id)
        }"
        @mouseleave="floatingBoxFadeOur"
      >
        <div class="project">
          <img
            :src="`${imgArray[project.id]}`"
            alt=""
          >
        </div>
    ...
    <div
      ...
      class="floating-info"
    >
      <h2 ref="floatinTextHeader" />

      <p ref="floatingTextDesc" />
    </div>
  </div>
</template>
