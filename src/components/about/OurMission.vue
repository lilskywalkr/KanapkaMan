    ...
    <div class="we-doing-mission-container">
        ...
        <div class="our-mission-section">
            <div class="our-mission">
                <h2 v-html="$t('ourMissionHeader')"></h2>
                <img src="../../assets/compass_white.svg" alt="comppass" class="compass"/>
                <p class="our-mission-conent">{{ $t('ourMissionContent') }}</p>
            </div>
        </div>
    </div>
</template>
